export default function Footer() {
  ...
  return (
    <footer style={{ borderTop: "1px solid #1a1a1a", background: "#111" }}>
      <div className="section-inner" style={{ padding: "3rem 2rem" }}>
        <div className="footer-top-inner">
          <div>
            <div style={{ fontFamily: "var(--font-syne),sans-serif", fontWeight: 800, fontSize: "1.5rem", color: "#f0ede6" }}>WM<span style={{ color: "#caff33" }}>.</span></div>
      ...
      <div style={{ borderTop: "1px solid #1a1a1a" }}>
        <div className="section-inner" style={{ padding: "1rem 2rem", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "0.5rem" }}>
          <p style={{ fontFamily: "var(--font-dm-mono),monospace", fontSize: "0.65rem", color: "#555" }}>© {year} Wajahat Mustafa. Crafted with <span style={{ color: "#caff33" }}>♥</span> in Karachi, PK.</p>
          <p style={{ fontFamily: "var(--font-dm-mono),monospace", fontSize: "0.65rem", color: "#555" }}>Built with <span style={{ color: "rgba(240,237,230,0.5)" }}>Next.js</span> & <span style={{ color: "rgba(240,237,230,0.5)" }}>Tailwind CSS</span></p>
        </div>
      </div>
    </footer>
  );
