...
export default function About() {
  return (
    <section
      id="about"
      style={{ position: "relative", padding: "8rem 0", overflow: "hidden", background: "#0a0a0a" }}
    >
      {/* Big BG number */}
      <div style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "5rem", alignItems: "start" }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ position: "relative", background: "#111", aspectRatio: "4/5", overflow: "hidden", zIndex: 1 }}>
              ...
              {/* Lime gradient overlay at bottom for name strip readability */}
              <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: "40%", background: "linear-gradient(to top, rgba(10,10,10,0.95) 0%, transparent 100%)", zIndex: 2, pointerEvents: "none" }} />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
            <h2 style={{ fontFamily: "var(--font-syne), sans-serif", fontWeight: 800, fontSize: "clamp(2rem, 4vw, 3.5rem)", color: "#f0ede6", lineHeight: 1.15 }}>
              Turning ideas into{" "}
              <span style={{ color: "#caff33" }}>digital reality</span>
            </h2>

            <div style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
              {[
                <>Hey — I&apos;m Wajahat. A passionate full stack developer with 3+ years of experience architecting web applications that don&apos;t just work — they <span style={{ color: "#f0ede6" }}>perform</span>.</>,
                <>I specialize in the JavaScript ecosystem: <span style={{ color: "#caff33" }}>React</span>, <span style={{ color: "#caff33" }}>Next.js</span>, <span style={{ color: "#caff33" }}>Node.js</span>, and <span style={{ color: "#caff33" }}>TypeScript</span>. I care deeply about developer experience, clean architecture, and shipping products users love.</>,
                <>When I&apos;m not writing code, I&apos;m exploring new technologies, contributing to open source, or thinking about how design and engineering intersect.</>,
              ].map((text, i) => (
                <p key={i} style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: "0.82rem", color: "#888", lineHeight: 1.9 }}>{text}</p>
              ))}
            </div>
            ...
            <div style={{ paddingTop: "0.5rem" }}>
              <a
                ...
                style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: "0.82rem", textTransform: "uppercase", letterSpacing: "0.1em", color: "#caff33", textDecoration: "none", transition: "color 0.3s" }}
